...
public enum Ext2fsSuperBlockEnum implements BlockEnum {
    ...
    s_mnt_count(52, ValueType.INTEGER, 2),
    ...
    //s_padding(253, 3, Values.ValueType.INTEGER),
    ...
    private final int sboffset = 1024; //start byte of super block.
     ...
     */
    Ext2fsSuperBlockEnum(long offset, ValueType valueType, int byteSize) {
        this.offset = sboffset + offset;
        this.byteSize = byteSize;
        this.valueType = valueType;
    }

    Ext2fsSuperBlockEnum(long offset, ValueType valueType) {
